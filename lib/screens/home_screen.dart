          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text('Ana Sayfa', style: AppTextStyles.bodyMedium.copyWith(color: AppColors.primary)),
                  IconButton(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text('Popüler Saç Modelleri', style: AppTextStyles.heading2),
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => GalleryDetailScreen(hairstyle: style)),
                          );
                        },
                        child: Container(
                          width: 120,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(style.name, style: AppTextStyles.bodyMedium, textAlign: TextAlign.center, maxLines: 1),
                              ),
                            ],
                          ),
                        ),
                ...
                Builder(
                  builder: (context) {
                    ...
                    if (filteredServices.isEmpty) {
                      return Center(
                        child: Text('Sonuç bulunamadı.', style: AppTextStyles.bodyLarge.copyWith(color: AppColors.textMuted)),
                      );
                    }
